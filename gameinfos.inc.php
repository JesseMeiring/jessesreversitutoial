...
'presentation' => array(
   totranslate("This is a tutorial build of Reversi (or Othello)"),
   totranslate("I used to play this game with my childhood friend Bryce and I feel like I was a real knob when I lost"),
   totranslate("Enjoy!")
),
